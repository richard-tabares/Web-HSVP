...
function enviarpqrsf() {
	...
	ajaxPqrsf.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	//enviando los datos para que guarden los datos
	ajaxPqrsf.send("nombres=" + nombres + "&apellidos=" + apellidos + "&tipoDocumento=" + tipoDocumento + "&documento=" + documento + "&telefono=" + telefono + "&correo=" + correo + "&genero=" + genero + "&direccion=" + direccion + "&barrio=" + barrio + "&dpto=" + dpto + "&municipio=" + municipio + "&eps=" + eps + "&tipoProceso=" + tipoProceso + "&area=" + area + "&alcance=" + alcance + "&descripcion=" + descripcion);
	}
